...
function doSomethingCol() {
  console.log("Something Cool!");
}

// Put your answer below -------------------------

var doSomethingCol = function () {
  console.log("Something Cool!");
}
...
//[C]: z then y, because the function set in a setTimeout for both console.log, but only
//has a 1 sec setback so it goes and prints out z first and then after 1 second it prints
//out y.
...
//this works but the .toLowerCase does not work,
//when I put in spainshColor("ROJO"), it comes up
// spanishColor is not defined
